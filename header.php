...
<body>
	<header>
        ...
        <div class="search-box">
            ...
            <button class="search-btn" name="search"><i class="fas fa-search"></i>
            </button>
            </form>
        </div>
        <div>
		  <ul class="navig">
		  	...
		  	if(isset($_SESSION['email'])){ ?>
		         ...
		         <li><a href='panier.php'><i class='fas fa-shopping-cart'></i>&nbsp;Mon panier<?php echo compter_produits();?></a></li>
